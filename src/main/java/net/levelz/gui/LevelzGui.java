...
public class LevelzGui extends LightweightGuiDescription {
        public LevelzGui(PlayerEntity playerEntity) {
                ...
                WDynamicLabel damageLabel = new WDynamicLabel(
                                () -> "" + (playerEntity.getMainHandStack().getItem() instanceof SwordItem ? ((SwordItem) playerEntity.getMainHandStack().getItem()).getAttackDamage()
