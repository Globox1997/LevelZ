...
public class AlchemyInfoScreen implements ISkillInfoScreen {
    @Override
    ...
    public <T extends Element & Drawable & Selectable> ArrayList<T> getWidgets(int x, int y, TextRenderer textRenderer) {
        ...
        list.add(Text.translatable("text.levelz.alchemy_info_1"));
        list.add(Text.translatable("text.levelz.alchemy_info_1_2"));
        list.add(Text.translatable("text.levelz.alchemy_info_2_1", new DecimalFormat("0.0").format(ConfigInit.CONFIG.alchemyEnchantmentChance * 100F)));
        list.add(Text.translatable("text.levelz.alchemy_info_2_2", new DecimalFormat("0.0").format(ConfigInit.CONFIG.alchemyEnchantmentChance * 100F)));
        list.add(null);
        list.add(null);
        list.add(Text.translatable("text.levelz.alchemy_max_lvl_1", new DecimalFormat("0.0").format(ConfigInit.CONFIG.alchemyPotionChance * 100F)));
        list.add(Text.translatable("text.levelz.alchemy_max_lvl_2", new DecimalFormat("0.0").format(ConfigInit.CONFIG.alchemyPotionChance * 100F)));
